...
CREATE TABLE `empresa` (
  ...
  `arq_foto` varchar(100) DEFAULT NULL,
...
CREATE TABLE `usuario_empresa` (
  ...
  `dsc_cargo` varchar(150) NOT NULL,
...
-- heroku_9439eb1c84438d2.controle_ponto definition

CREATE TABLE `controle_ponto` (
  `id_controle_ponto` int(11) NOT NULL AUTO_INCREMENT,
  `id_usuario_empresa` int(11) NOT NULL,
  `dat_ponto` date NOT NULL,
  `tim_entrada` time NOT NULL,
  `tim_saida` time NOT NULL,
  `tim_inicio_almoco` time DEFAULT NULL,
  `tim_fim_almoco` time DEFAULT NULL,
  PRIMARY KEY (`id_controle_ponto`),
  KEY `controle_ponto_FK` (`id_usuario_empresa`),
  CONSTRAINT `controle_ponto_FK` FOREIGN KEY (`id_usuario_empresa`) REFERENCES `usuario_empresa` (`id_usuario_empresa`)
...
-- heroku_9439eb1c84438d2.lembrete definition

CREATE TABLE `lembrete` (
  `id_lembrete` int(11) NOT NULL AUTO_INCREMENT,
  `dsc_lembrete` varchar(200) NOT NULL,
  `dat_lembrete` date NOT NULL,
  `id_usuario_empresa` int(11) NOT NULL,
  PRIMARY KEY (`id_lembrete`),
  KEY `lembrete_FK` (`id_usuario_empresa`),
  CONSTRAINT `lembrete_FK` FOREIGN KEY (`id_usuario_empresa`) REFERENCES `usuario_empresa` (`id_usuario_empresa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `atividade` (
  ...
  KEY `atividade_FK` (`id_projeto`),
  KEY `atividade_FK_1` (`id_quadro`),
  KEY `atividade_FK_2` (`id_etapa`),
  CONSTRAINT `atividade_FK` FOREIGN KEY (`id_projeto`) REFERENCES `projeto` (`id_projeto`),
...
-- heroku_9439eb1c84438d2.subatividade definition

CREATE TABLE `subatividade` (
  `id_subatividade` int(11) NOT NULL AUTO_INCREMENT,
  `id_atividade` int(11) NOT NULL,
  `dsc_nome` varchar(200) NOT NULL,
  `dsc_descricao` varchar(700) DEFAULT NULL,
  PRIMARY KEY (`id_subatividade`),
  KEY `subatividade_FK` (`id_atividade`),
  CONSTRAINT `subatividade_FK` FOREIGN KEY (`id_atividade`) REFERENCES `atividade` (`id_atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;